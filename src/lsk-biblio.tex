...
\bibitem{local} \LaTeX{}을 설치한 시스템 관리자는 \emph{\LaTeX{} Local Guide}라는 
...
\bibitem{verbatim} Rainer~Sch\"opf, Bernd~Raichle, and Chris~Rowley.
...
%    is a very complete listing of many \TeX{} and \LaTeX{}
%    related packages.
...
\bibitem{xetexko} Dohyun Kim,
  \newblock \bnm{\XeTeX-ko 간단 매뉴얼},
